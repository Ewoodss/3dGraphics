...
ObjModel::ObjModel(const std::string &fileName) {
    ...
    while (!pFile.eof()) {
        ...
        } else if (params[0] == "s") {//smoothing groups
...
void ObjModel::loadMaterialFile(const std::string &fileName, const std::string &dirName) {
    ...
    while (!pFile.eof()) {
        ...
        } else if (params[0] == "kd") {//TODO, diffuse color
        } else if (params[0] == "ka") {//TODO, ambient color
        } else if (params[0] == "ks") {//TODO, specular color
        } else if (
                params[0] == "illum" ||
                params[0] == "map_bump" ||
                params[0] == "map_ke" ||
